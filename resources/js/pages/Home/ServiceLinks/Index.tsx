...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Service Links', href: '#' },
];

export default function ServiceLinksIndex({ links }: Props) {
    const handleDelete = (id: number) => {
        router.delete(`/admin/home-service-links/${id}`, { preserveScroll: true });
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Service Links" />
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
                <div className="flex items-center justify-between">
                    ...
                    <Link href="/admin/home-service-links/create">
                            ...
                            {links.length === 0 ? (
                                ...
                                links.map((link) => (
                                    <TableRow key={link.id}>
                                        ...
                                        <TableCell>
                                            <code className="rounded bg-muted px-2 py-1 text-sm">{link.slug}</code>
                                        </TableCell>
                                        <TableCell className="text-right">
                                            <div className="flex justify-end gap-2">
                                                <Link href={`/admin/home-service-links/${link.id}/edit`}>
