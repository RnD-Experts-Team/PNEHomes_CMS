                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                      <Input
                        ...
                        onChange={(e) =>
                          firstSectionForm.setData('mobile_cover_image_id', e.target.value)
                        }
                        placeholder="Enter Google Drive image ID"
                      />
                      <IdPickerButton
                        onPick={(id) => firstSectionForm.setData('mobile_cover_image_id', id)}
                      />
                    </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                      <Input
                        ...
                        onChange={(e) =>
                          firstSectionForm.setData('logo_image_id', e.target.value)
                        }
                        placeholder="Enter Google Drive image ID"
                      />
                      <IdPickerButton
                        onPick={(id) => firstSectionForm.setData('logo_image_id', id)}
                      />
                    </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => firstSectionForm.setData('title', e.target.value)}
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => firstSectionForm.setData('subtitle', e.target.value)}
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        firstSectionForm.setData('book_button_text', e.target.value)
                      }
                  ...
                  <div className="flex justify-end">
                    <Button type="submit" disabled={firstSectionForm.processing}>
                      {firstSectionForm.processing ? 'Updating...' : 'Update First Section'}
                    </Button>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                    ...
                    {heroForm.errors.title && (
                      <p className="text-sm text-destructive">{heroForm.errors.title}</p>
                    )}
                  </div>
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => servicesForm.setData('title', e.target.value)}
                      placeholder="Enter services title"
                    />
                    {servicesForm.errors.title && (
                      <p className="text-sm text-destructive">{servicesForm.errors.title}</p>
                    )}
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="services_cover">Cover Image ID (Google Drive) *</Label>
                    <div className="flex gap-2">
                      <Input
                        id="services_cover"
                        value={servicesForm.data.cover_image_id}
                        onChange={(e) => servicesForm.setData('cover_image_id', e.target.value)}
                        placeholder="Enter Google Drive image ID"
                      />
                      <IdPickerButton
                        onPick={(id) => servicesForm.setData('cover_image_id', id)}
                      />
                    </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      onChange={(e) => servicesForm.setData('description', e.target.value)}
                  ...
                  <div className="flex justify-end">
                    <Button type="submit" disabled={servicesForm.processing}>
                      {servicesForm.processing ? 'Updating...' : 'Update Services'}
                    </Button>
                  </div>
                </CardContent>
              </Card>
          ...
          <TabsContent value="grid" className="space-y-4">
            <form onSubmit={handleGridSectionSubmit}>
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                    <Label htmlFor="grid_video_id">Video ID (Google Drive) *</Label>
                    <div className="flex gap-2">
                      <Input
                        id="grid_video_id"
                        value={gridSectionForm.data.video_id}
                        onChange={(e) => gridSectionForm.setData('video_id', e.target.value)}
                        placeholder="Enter Google Drive video ID"
                      />
                      <IdPickerButton
                        onPick={(id) => gridSectionForm.setData('video_id', id)}
                      />
                    </div>
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="grid_logo_image_id">Logo Image ID (Google Drive) *</Label>
                    <div className="flex gap-2">
                      <Input
                        id="grid_logo_image_id"
                        value={gridSectionForm.data.logo_image_id}
                        onChange={(e) =>
                          gridSectionForm.setData('logo_image_id', e.target.value)
                        }
                        placeholder="Enter Google Drive image ID"
                      />
                      <IdPickerButton
                        onPick={(id) => gridSectionForm.setData('logo_image_id', id)}
                      />
                    </div>
                  ...
                  <div className="flex justify-end">
                    <Button type="submit" disabled={gridSectionForm.processing}>
                      {gridSectionForm.processing ? 'Updating...' : 'Update Grid Section'}
                    </Button>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex justify-end">
                    <Button type="submit" disabled={settingsForm.processing}>
                      {settingsForm.processing ? 'Updating...' : 'Update Settings'}
                    </Button>
                  </div>
                </CardContent>
              </Card>
