...
const breadcrumbs: BreadcrumbItem[] = [{ title: 'Home Page', href: '#' }];
...
export default function HomePage({ homeData }: Props) {
    ...
    const firstSectionForm = useForm({
        mobile_cover_image_id:
            homeData.first_section?.mobile_cover_image_id || '',
        mobile_cover_image_type:
            homeData.first_section?.mobile_cover_image_type || 'image',

        logo_image_id: homeData.first_section?.logo_image_id || '',
        logo_image_type: homeData.first_section?.logo_image_type || 'image',
    ...
    const servicesForm = useForm({
        ...
        cover_image_type: homeData.services?.cover_image_type || 'image',
    ...
    const gridSectionForm = useForm({
        ...
        video_type: homeData.grid_section?.video_type || 'video',

        logo_image_id: homeData.grid_section?.logo_image_id || '',
        logo_image_type: homeData.grid_section?.logo_image_type || 'image',
    });
            ...
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
                ...
                >
                    <TabsList className="grid w-full grid-cols-5">
                        <TabsTrigger value="first-section">
                            First Section
                        </TabsTrigger>
                                ...
                                <CardContent className="space-y-4">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Input
                                            id="subtitle"
                                            value={
                                                firstSectionForm.data.subtitle
                                            }
                                            onChange={(e) =>
                                                firstSectionForm.setData(
                                                    'subtitle',
                                    ...
                                    <div className="space-y-2">
                                        <Label htmlFor="book_button_text">
                                            Book Button Text
                                        </Label>
                                        <Input
                                            id="book_button_text"
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <p className="text-sm text-muted-foreground">
                                    {homeData.hero_sections?.length || 0}{' '}
                    ...
                    <TabsContent value="services" className="space-y-4">
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <p className="text-sm text-muted-foreground">
                                    {homeData.service_links?.length || 0}{' '}
                                    link(s) configured
                                </p>
                            </CardContent>
                        </Card>
                    ...
                    <TabsContent value="grid" className="space-y-4">
                                ...
                                <CardContent className="space-y-4">
                                    <div className="space-y-2">
                                        ...
                                        {gridSectionForm.errors.video_id && (
                                            <p className="text-sm text-destructive">
                                                {
                                                    gridSectionForm.errors
                                                        .video_id
                                                }
                                            </p>
                                        )}
                                        {gridSectionForm.errors.video_type && (
                                            <p className="text-sm text-destructive">
                                                {
                                                    gridSectionForm.errors
                                                        .video_type
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <p className="text-sm text-muted-foreground">
                                    {homeData.grid_links?.length || 0} link(s)
                                    configured
                                </p>
                            </CardContent>
                        </Card>
                                ...
                                <CardContent className="space-y-4">
                                    <div className="space-y-2">
                                        ...
                                        <Input
                                            id="contact_title"
                                            value={
                                                settingsForm.data.contact_title
                                            }
                                            onChange={(e) =>
