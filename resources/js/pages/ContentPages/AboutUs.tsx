...
const breadcrumbs: BreadcrumbItem[] = [{ title: 'About Us', href: '#' }];
...
export default function AboutUsPage({ aboutUs }: Props) {
    const { data, setData, put, processing, errors } = useForm<FormData>({
        ...
        cover_image_type: aboutUs?.cover_image_type || 'image',
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-xs text-muted-foreground">
                                    This editor supports headings, colors,
                                    lists, links, images (upload or URL), video,
                                    code blocks, RTL, and more.
                                </p>
                            </div>
                        </CardContent>
                    </Card>
