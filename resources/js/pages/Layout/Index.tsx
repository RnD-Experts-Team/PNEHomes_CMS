...
export default function LayoutIndex({ layoutData }: Props) {
    ...
    const navigationForm = useForm({
        ...
        logo_image_type: layoutData.navigation?.logo_image_type || 'image',
    });
                ...
                >
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <p className="text-sm text-muted-foreground">
                                    {layoutData.navigation_links.length} link(s)
                                    configured
                                </p>
                            </CardContent>
                        </Card>
                    ...
                    <TabsContent value="footer" className="space-y-4">
                        <Card>
                            ...
                            <CardContent>
                                <p className="text-sm text-muted-foreground">
                                    {layoutData.footer_links.length} link(s)
                                    configured
                                </p>
                            </CardContent>
                        </Card>
                    ...
                    <TabsContent value="contact-nav" className="space-y-4">
                        <form onSubmit={handleContactNavSubmit}>
                            <Card>
                                <CardHeader>
                                    <CardTitle>
                                        Contact Info (Header/Navigation)
                                    </CardTitle>
                                </CardHeader>
                                <CardContent className="space-y-4">
                                    <div className="space-y-2">
                                        <Label htmlFor="nav_phone">
                                            Phone (digits only)
                                        </Label>
                                        <Input
                                            id="nav_phone"
                                    ...
                                    <div className="flex justify-end">
                                        <Button
                                            type="submit"
                                            disabled={contactNavForm.processing}
                                        >
                                            {contactNavForm.processing
                                                ? 'Updating...'
                    ...
                    <TabsContent value="social" className="space-y-4">
                        <Card>
                            ...
                            <CardContent>
                                <p className="text-sm text-muted-foreground">
                                    {layoutData.social_links.length} link(s)
                                    configured
                                </p>
                            </CardContent>
                        </Card>
