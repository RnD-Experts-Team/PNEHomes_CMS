...
export default function GalleryAlbumsIndex({ albums }: Props) {
            ...
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                        <Link href="/admin/gallery-settings">
                                    ...
                                    <TableRow key={album.id}>
                                        ...
                                        <TableCell>
                                            <Badge variant="outline">
                                                {album.has_sub_albums ? 'With Sub-Albums' : 'Direct Images'}
                                            </Badge>
                                        </TableCell>
                                        <TableCell>
                                        ...
                                        <TableCell className="text-right">
                                            <div className="flex justify-end gap-2">
                                                <Link href={`/admin/gallery-albums/${album.id}/edit`}>
                                                    ...
                                                    <AlertDialogContent>
                                                        <AlertDialogHeader>
                                                            ...
                                                            <AlertDialogDescription>
                                                                ...
                                                                will also delete all sub-albums and images. This
